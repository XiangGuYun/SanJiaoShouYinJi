 ...
 */
package android_serialport_api.cardwriteread.baiduface.baidumodel;
...
public class LivenessModel {
    ...
    public String toString() {
        return "LivenessModel{" +
                ...
                ", trackFaceInfo=" + Arrays.toString(trackFaceInfo) +
                ", allDetectDuration=" + allDetectDuration +
                '}';
    }
}
