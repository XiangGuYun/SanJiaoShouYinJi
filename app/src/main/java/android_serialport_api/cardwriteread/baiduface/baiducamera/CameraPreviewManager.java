package android_serialport_api.cardwriteread.baiduface.baiducamera;
...
//            }
            ...
            switch (cameraFacing) {
                case CAMERA_FACING_FRONT: {
                    ...
                    mCamera.setDisplayOrientation(SPUtils.INSTANCE.getInt(MyApplication.getAppContext(), "displayOrient", 0, "default"));
                    break;
                }
...
//                    cameraRotation = getCameraDisplayOrientation(cameraRotation, cameraId);
            ...
            if (cameraRotation == 90 || cameraRotation == 270) {
                ...
                // 旋转90度或者270，需要调整宽高
//                mTextureView.setPreviewSize(previewHeight % 2 == 0 ?
//                        previewHeight : previewHeight - 1, previewWidth % 2 == 0 ? previewWidth : previewWidth - 1);
...
//            params.setPreviewSize(videoWidth%2==0?videoWidth:videoWidth-1, videoHeight%2==0?videoHeight:videoHeight-1);
