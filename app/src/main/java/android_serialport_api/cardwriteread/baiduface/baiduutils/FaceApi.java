 ...
 */
package android_serialport_api.cardwriteread.baiduface.baiduutils;
...
import android_serialport_api.cardwriteread.baiduface.baidumodel.ResponseGetRecords;
...
public class FaceApi {
    ...
    public float getFeature(Bitmap bitmap, byte[] feature, BDFaceSDKCommon.FeatureType featureType) {
        ...
        float ret = -1;
        BDFaceImageInstance imageInstance = null;
        try {
            imageInstance = new BDFaceImageInstance(bitmap);
            // 最大检测人脸，获取人脸信息
